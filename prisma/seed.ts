...
const SERVICES = [
  {
    key: "stage1", durationMin: 180, price: 3_500_000,
    name: "Чип-тюнинг Stage 1", nameUz: "Chip-tyuning Stage 1", nameEn: "ECU Tuning Stage 1",
    category: "Двигатель", categoryUz: "Dvigatel", categoryEn: "Engine",
  ...
  {
    key: "stage2", durationMin: 360, price: 9_900_000,
    name: "Stage 2 + даунпайп", nameUz: "Stage 2 + daunpayp", nameEn: "Stage 2 + Downpipe",
    category: "Двигатель", categoryUz: "Dvigatel", categoryEn: "Engine",
  ...
  {
    key: "dyno", durationMin: 60, price: 350_000,
    name: "Диагностика и дино-замер", nameUz: "Diagnostika va dinostendda o'lchov", nameEn: "Diagnostics & Dyno Run",
    category: "Двигатель", categoryUz: "Dvigatel", categoryEn: "Engine",
  ...
  {
    key: "exhaust", durationMin: 240, price: 5_500_000,
    name: "Спортивный выхлоп", nameUz: "Sport chiqarish tizimi", nameEn: "Sports Exhaust",
    category: "Выхлоп", categoryUz: "Chiqarish tizimi", categoryEn: "Exhaust",
  ...
  {
    key: "coilovers", durationMin: 240, price: 2_900_000,
    name: "Установка койловеров", nameUz: "Koyloverlarni o'rnatish", nameEn: "Coilover Installation",
    category: "Подвеска", categoryUz: "Osma", categoryEn: "Suspension",
  ...
  {
    key: "air", durationMin: 480, price: 18_500_000,
    name: "Пневмоподвеска", nameUz: "Pnevmoosma", nameEn: "Air Suspension",
    category: "Подвеска", categoryUz: "Osma", categoryEn: "Suspension",
  ...
  {
    key: "ppf", durationMin: 480, price: 16_900_000,
    name: "Оклейка PPF", nameUz: "PPF plyonka bilan qoplash", nameEn: "Full PPF Wrap",
    category: "Кузов", categoryUz: "Kuzov", categoryEn: "Body",
  ...
  {
    key: "ceramic", durationMin: 240, price: 3_200_000,
    name: "Керамика кузова", nameUz: "Kuzovga keramik qoplama", nameEn: "Ceramic Coating",
    category: "Кузов", categoryUz: "Kuzov", categoryEn: "Body",
  ...
  {
    key: "tint", durationMin: 120, price: 900_000,
    name: "Тонировка", nameUz: "Tonirovka", nameEn: "Window Tint",
    category: "Кузов", categoryUz: "Kuzov", categoryEn: "Body",
  ...
  {
    key: "interior", durationMin: 480, price: 12_500_000,
    name: "Перетяжка салона", nameUz: "Salonni qayta qoplash", nameEn: "Interior Retrim",
    category: "Салон", categoryUz: "Salon", categoryEn: "Interior",
  ...
  {
    key: "sound", durationMin: 360, price: 4_800_000,
    name: "Шумоизоляция", nameUz: "Shovqin izolyatsiyasi", nameEn: "Sound Deadening",
    category: "Салон", categoryUz: "Salon", categoryEn: "Interior",
...
const MASTERS = [
  {
    name: "Шерзод Каримов", nameLatin: "Sherzod Karimov", color: "#FF5A1F",
    specialty: "Двигатель и чип-тюнинг", specialtyUz: "Dvigatel va chip-tyuning", specialtyEn: "Engines & ECU tuning",
    ...
    services: ["stage1", "stage2", "dyno"], days: [1, 2, 3, 4, 5], start: h(10), end: h(19),
  },
  {
    name: "Дмитрий Волков", nameLatin: "Dmitriy Volkov", color: "#FFB020",
    specialty: "Подвеска и выхлоп", specialtyUz: "Osma va chiqarish tizimi", specialtyEn: "Suspension & exhaust",
    ...
    services: ["exhaust", "coilovers", "air", "dyno"], days: [2, 3, 4, 5, 6], start: h(10), end: h(20),
  },
  {
    name: "Виктор Ким", nameLatin: "Viktor Kim", color: "#22D3EE",
    specialty: "Детейлинг и PPF", specialtyUz: "Deteyling va PPF", specialtyEn: "Detailing & PPF",
    ...
    services: ["ppf", "ceramic", "tint"], days: [1, 2, 3, 4, 5, 6], start: h(9), end: h(18),
  },
  {
    name: "Ренат Хайруллин", nameLatin: "Renat Khayrullin", color: "#A78BFA",
    specialty: "Салон и шумоизоляция", specialtyUz: "Salon va shovqin izolyatsiyasi", specialtyEn: "Interiors & sound deadening",
    ...
    services: ["interior", "sound", "tint"], days: [1, 3, 4, 5, 6], start: h(11), end: h(20),
  },
  {
    name: "Айгерим Сейтжанова", nameLatin: "Aigerim Seytjanova", color: "#34D399",
    specialty: "Керамика и тонировка", specialtyUz: "Keramika va tonirovka", specialtyEn: "Ceramic coating & tint",
    ...
    services: ["ceramic", "tint"], days: [2, 3, 4, 5, 6], start: h(10), end: h(19),
  },
];

const CLIENTS = ["Жасур", "Нодира", "Отабек", "Ольга", "Сергей Пак", "Дильноза", "Тимур Ахмедов", "Камила", "Азиз", "Артём", "Бахтиёр", "Эльвира"];
const CARS = ["Chevrolet Malibu 2", "Chevrolet Tracker", "BYD Song Plus", "Toyota Camry 75", "Lexus LX 600", "BMW 530i G30", "Mercedes-Benz E 300", "Kia K5", "Hyundai Sonata", "Toyota Land Cruiser 300", "Li Auto L7", "Chevrolet Tahoe"];
